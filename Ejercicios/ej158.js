...
const juegosAsc = juegos.sort(function(a,b){
    return parseFloat(a.precio) - parseFloat(b.precio);
});

const juegosDesc = juegos.sort(function(a,b){
    return parseFloat(b.precio) - parseFloat(a.precio);
});


const mostrar = function (juego){
    juego.imprimirEnPantalla()
};

const mostrarFiltrado = function (juego){
...
//Imprimir juegos
//juegosAsc.forEach(mostrar);
//juegosDesc.forEach(mostrar);

juegosDesc.forEach(mostrarFiltrado);
